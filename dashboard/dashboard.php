...
<?php if ($_GET ['content'] == 43) {?>
<p class="labelData">
			<span>Payment Pending</span><span style="float: right; width: 24%">Support</span>
		</p>
		<div class="row">
...
<p class="labelData">
			<span>Batch</span><span style="float: right; width: 24%">Support
	...
	?>
		...
		<p class="labelData">
			<span>Interview Closed Transaction</span> <span
				style="float: right; width: 47%">Training Closed Transaction</span>
		</p>
		<div class="row">
			<div class='left1' id="none">
				<table data-filter="#filter" class="footable">
