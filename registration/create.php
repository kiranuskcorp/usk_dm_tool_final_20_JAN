			...
			<form class="form-horizontal" action="./registration/create.php"
					...
					<div class="form-group required">
						...
						<div class="controls">
							<input name="password" id="password" type="password" placeholder="Password"
								value="<?php echo !empty($password)?$password:'';?>" onchange="checkPasswordAndConform()"
								 required>
				...
				<div
					...
					<div class="form-group required">
						...
						<div class="controls">
							<input name="conformPassword" id="conformPassword" type="password" placeholder="Conform Password"
								value="<?php echo !empty($conformPassword)?$conformPassword:'';?>" onchange="checkPasswordAndConform()"
								 required>
